...
def main():
    ...
    test_input_array = np.array(test_input, dtype='float32')
    test_input_array /= 255.0
    test_input_array = test_input_array.reshape(1, -1)
    #plt.imshow(image_array, cmap='gray')
    #plt.title('Processed Digit 4')
    #plt.axis('off')
    #plt.show()
    ...
    predicted_digit, output_probs = predict(nn, test_input_array)
